...
function isFeature() {
    return Cypress.env(constants_1.INTERNAL_PROPERTY_NAME) != null;
}
...
function doesFeatureMatch(expression) {
    const { pickle } = (0, assertions_1.assertAndReturn)(Cypress.env(constants_1.INTERNAL_PROPERTY_NAME), exports.NOT_FEATURE_ERROR);
