    ...
    switch (key) {
        ...
        case "json": {
            ...
            if (hasOwnProperty(value, "args")) {
                if (Array.isArray(value.args) && value.args.every(type_guards_1.isString)) {
                    args = value.args;
                }
                else {
                    throw new Error(`Expected an array of strings (json.args), but got ${util_1.default.inspect(value)}`);
                }
            }
            if (!hasOwnProperty(value, "enabled") ||
                typeof value.enabled !== "boolean") {
...
function validateEnvironmentOverrides(environment) {
    ...
    if (hasOwnProperty(environment, "jsonArgs")) {
        ...
        if ((0, type_guards_1.isString)(jsonArgs)) {
            overrides.jsonArgs = [jsonArgs];
        }
        if (Array.isArray(jsonArgs) && jsonArgs.every(type_guards_1.isString)) {
            overrides.jsonArgs = jsonArgs;
        }
        else {
            throw new Error(`Expected a string array (jsonArgs), but got ${util_1.default.inspect(jsonArgs)}`);
        }
    }
...
class PreprocessorConfiguration {
    ...
    get stepDefinitions() {
        ...
        return exports.DEFAULT_STEP_DEFINITIONS.map((pattern) => pattern.replace("[integration-directory]", (0, helpers_1.ensureIsRelative)(config.projectRoot, "integrationFolder" in config
    ...
    get json() {
        ...
        return {
            args: (_c = (_a = this.environmentOverrides.jsonArgs) !== null && _a !== void 0 ? _a : (_b = this.explicitValues.json) === null || _b === void 0 ? void 0 : _b.args) !== null && _c !== void 0 ? _c : [],
            enabled: (_f = (_d = this.environmentOverrides.jsonEnabled) !== null && _d !== void 0 ? _d : (_e = this.explicitValues.json) === null || _e === void 0 ? void 0 : _e.enabled) !== null && _f !== void 0 ? _f : false,
            formatter: (_j = (_g = this.environmentOverrides.jsonFormatter) !== null && _g !== void 0 ? _g : (_h = this.explicitValues.json) === null || _h === void 0 ? void 0 : _h.formatter) !== null && _j !== void 0 ? _j : "cucumber-json-formatter",
            output: (_k = this.environmentOverrides.jsonOutput) !== null && _k !== void 0 ? _k : (((_l = this.explicitValues.json) === null || _l === void 0 ? void 0 : _l.output) || "cucumber-report.json"),
        };
    }
    get html() {
        var _a, _b, _c, _d, _e, _f;
